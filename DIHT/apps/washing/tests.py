...
class CreateRecordTestCase(TestCase):
    ...
    def test_create_record_ok(self):
        ...
        self.assertTemplateUsed(response, 'washing/create_record.html')
        self.assertEqual(response.status_code, 200)
        self.assertEqual(self.user.operations.all().count(), 1)
        self.assertEqual(self.user.operations.all()[0].amount, -100)
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(self.user.operations.all().count(), 2)
        self.assertEqual(self.user.operations.all()[1].amount, -0)
